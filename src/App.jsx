...
import {
  sendChat, createAgent, uploadDocument, login, signup, getCurrentUser,
...
// sends nothing, this stands in (see backend/docs/CHAT_FILE_CONTEXT.md).
...
// Backend stores one record per question+answer pair (see
// backend/docs/CHAT_TRASH_API.md) — there's no "chat session" concept
// server-side, so the UI groups these by persona instead (see
// `recentConversations` below).
